...
public class AccountsServiceTest {
	...
	public void fundTransfer() throws Exception {
		...
		ResponseEntity<Object> resp = this.accountsService.fundTransfer("00001", "00002", 50.00F);
		String respString = resp.getBody().toString();
		assertEquals(respString, "Transfered Successfully");
	}
}
